...
const state={token:localStorage.getItem('aps_token')||'',user:null,systemConfig:null,page:'dashboard',masterType:'order',masterOrderType:APS.scheduleType.MACHINING,masterCalendarType:APS.scheduleType.MACHINING,masterRecords:[],versions:[],users:[],effectiveData:null,effectiveFilters:{},effectiveView:'order',lockTarget:null,dragAdjustment:null,pendingAdjustment:null};
